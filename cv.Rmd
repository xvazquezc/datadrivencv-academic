...
if (params$long_cv == TRUE) {
  glue::glue(
    "[<i class='fas fa-download'></i> Download a PDF of this CV]({params$repository}/raw/master/cv_long.pdf)",
    .open = "{{", .close = "}}")
} else {
  glue::glue(
    "[<i class='fas fa-download'></i> Download the extended version of this CV]({params$repository}/raw/master/cv_long.pdf)",
    .open = "{{", .close = "}}")
